...
class BulkPowerActionCommand extends Command
{
    ...
    public function handle(DaemonServerRepository $repository, ValidatorFactory $validator): void
    {
        ...
        $this->getQueryBuilder($servers, $nodes)->get()->each(function ($server, int $index) use ($action, $repository, &$bar): mixed {
            $bar->clear();
