...
return [
    ...
    'upgrade' => [
        ...
        'source_url' => 'Download :type (set with --url=):',
        ...
        'are_your_sure' => 'Are you sure you want to run the :type process for your Panel?',
        'terminated' => ':type process terminated by user.',
        'success' => 'Panel has been successfully :type. Please ensure you also update any Daemon instances',
    ],
];
