...
@php
    ...
    $hasPrefix = count($prefixActions) || $prefixIcon || filled($prefix) || filled($prefixComponent);
    $hasSuffix = count($suffixActions) || $suffixIcon || filled($suffix) || filled($suffixComponent);
